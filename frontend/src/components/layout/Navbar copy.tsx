...
export default function Navbar() {
  ...
  const primaryLabel = displayStudentName || user?.email || roleLabel;
  ...
  const navLinkClass =
    "text-sm font-medium text-slate-600 dark:text-slate-300 hover:text-slate-900 dark:hover:text-white px-2 py-1 rounded-md hover:bg-slate-100 dark:hover:bg-slate-700 whitespace-nowrap transition";
            ...
            <nav className="flex items-center gap-4 md:gap-6 flex-wrap">
              {isAdminLike ? (
                <>
                  ...
                  <Link to="/receipts" className={navLinkClass}>
                    Receipts
                  </Link>
                  <Link to="/fee-assignments" className={navLinkClass}>
                    Fee Assignments
                  </Link>
                  <Link to="/class-sections" className={navLinkClass}>
                    Class Sections
                  </Link>
                  <Link to="/students" className={navLinkClass}>
                    Students
                  </Link>
                  <Link to="/fee-components" className={navLinkClass}>
                    Fee Components
                  </Link>
                  <Link to="/fee-plans" className={navLinkClass}>
                    Fee Plans
                  </Link>
                  <Link to="/admin/csv" className={navLinkClass}>
                    CSV Import
                  </Link>
                </>
              ) : (
                <>
                  <Link to="/my/invoices" className={navLinkClass}>
                    My Invoices
                  </Link>
                  <Link to="/my/receipts" className={navLinkClass}>
                    My Receipts
                  </Link>
                </>
              )}
