...
## 6.2 Students
- Go to Students:  
  - Add new students: Name, Roll number, Class section  
  - Edit existing students: Name, roll number, class section  
...
- Click on a plan to open Fee Plan Detail. For each component:  
...
- For each student, choose:  
  - Student  
  - Fee plan  
  - Optionally add concession (numeric discount) and note  
